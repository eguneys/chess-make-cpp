...
namespace Chess {
    ...
    constexpr KnightFeatureFn bishop_only_defended_by_knight = [](const Position &p, const PieceInstance &k) {
    ...
    class BitsetManager {
        ...
        public:
            ...
            private:
                ...
                std::vector<PieceInstance> knights;

                u64 nb_bishops;
                u64 current_bishop_index;
                std::vector<PieceInstance> bishops;
            };
}